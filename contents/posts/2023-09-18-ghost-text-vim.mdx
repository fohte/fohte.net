...
date: '2023-09-18T10:05:46+09:00'
tags: [vim]
description: ''
---
...
筆者は幾度となくありました。
これを [GhostText](https://ghosttext.fregante.com/) を使って実現でき快適にテキスト入力体験を得られているため、今回はその GhostText について紹介します。
...
プロトコルのドキュメントが公開されており、サポートしているブラウザやエディターが無い場合は自作も可能です。
...
すべてのブラウザでの入力を GhostText で使えるかというと、使えない場面もあります。
...
各ブラウザ拡張機能・エディタープラグインは [公式ドキュメント](https://ghosttext.fregante.com/) にリンクされています。
...
- Neovim 側で GhostText が自動起動しないようにする (手動で立ち上げるため)
  - <script src="https://emgithub.com/embed-v2.js?target=https%3A%2F%2Fgithub.com%2Ffohte%2Fdotfiles%2Fblob%2F52fc6b35b95767597eb225b89f394424e5a7b03d%2Fconfig%2Fnvim%2Flua%2Fplugins%2Fnvim-ghost.lua%23L2-L5&style=github&type=code&showBorder=on&showLineNumbers=on&showFileMeta=on&showFullPath=on&showCopy=on"></script>
- WezTerm で GhostText 専用のウィンドウを立ち上げる
  - <script src="https://emgithub.com/embed-v2.js?target=https%3A%2F%2Fgithub.com%2Ffohte%2Fdotfiles%2Fblob%2F52fc6b35b95767597eb225b89f394424e5a7b03d%2Fconfig%2Fwezterm%2Fwezterm.lua%23L43-L62&style=github&type=code&showBorder=on&showLineNumbers=on&showFileMeta=on&showFullPath=on&showCopy=on"></script>
  - <script src="https://emgithub.com/embed-v2.js?target=https%3A%2F%2Fgithub.com%2Ffohte%2Fdotfiles%2Fblob%2F52fc6b35b95767597eb225b89f394424e5a7b03d%2Froles%2Fbin%2Ffiles%2Fwezterm-user-command%23L1-L8&style=github&type=code&showBorder=on&showLineNumbers=on&showFileMeta=on&showFullPath=on&showCopy=on"></script>
  - `$ wezterm-user-command new-ghosttext-window` で起動
- Hammerspoon で WezTerm の専用ウィンドウにフォーカスするショートカットを割り当てる
  - <script src="https://emgithub.com/embed-v2.js?target=https%3A%2F%2Fgithub.com%2Ffohte%2Fdotfiles%2Fblob%2F52fc6b35b95767597eb225b89f394424e5a7b03d%2Fconfig%2Fhammerspoon%2Finit.lua%23L21-L30&style=github&type=code&showBorder=on&showLineNumbers=on&showFileMeta=on&showFullPath=on&showCopy=on"></script>
